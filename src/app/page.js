export default function Home() {
  return (
    <section className="bg-home-background-mobile bg-no-repeat bg-cover bg-center bg-fixed h-full w-full font-sans text-center text-sky-blue mt-12 px-6">
      ...
      <h2 className="text-white text-[80px] leading-tight font-serif uppercase mt-4">
        Space
      </h2>
      ...
      <button
        type=""
        className="text-xl leading-[22.92px] tracking-wider bg-white text-dark-blue rounded-full h-[150px] w-[150px] uppercase mt-20"
      >
        Explore
      </button>
    </section>
